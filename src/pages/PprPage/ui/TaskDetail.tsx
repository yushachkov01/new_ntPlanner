...
type Status = 'done' | 'done_on_time' | 'overtime' | 'pending_manual' | 'pending_auto' | 'info';
...
interface TaskDetailProps {
  ...
  onClose: () => void;
  /**
   * Если нужно передать данные (id, файл, описание)
   */
...
/**
 * Заглушечная функция для описания, если реального текста нет.
 */
const DESCS: Record<string, string[]> = {};
const getDesc = (id: number, t: string) =>
