...
export type FetchLastInterfacesQuery = { __typename?: 'query_root', query: Array<{ __typename?: 'query', status: string, received_at: any, result?: any | null }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    FetchLastInterfaces(variables: FetchLastInterfacesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchLastInterfacesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchLastInterfacesQuery>({ document: FetchLastInterfacesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'FetchLastInterfaces', 'query', variables);
    }
  };
}
