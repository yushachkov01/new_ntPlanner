...
export type InsertInterfaceRequestMutation = { __typename?: 'mutation_root', insert_query_one?: { __typename?: 'query', id: any } | null };


export const InsertInterfaceRequestDocument = gql`
    mutation InsertInterfaceRequest($dev: uuid!, $type: String!) {
  insert_query_one(object: {device: $dev, request_type: $type}) {
    id
  }
}
    `;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    InsertInterfaceRequest(variables: InsertInterfaceRequestMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<InsertInterfaceRequestMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<InsertInterfaceRequestMutation>({ document: InsertInterfaceRequestDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'InsertInterfaceRequest', 'mutation', variables);
    }
  };
}
