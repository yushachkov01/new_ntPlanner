...
export type FetchNodesQuery = { __typename?: 'query_root', nodes: Array<{ __typename?: 'nodes', id: any, name: string, address?: string | null, city_id: any }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchNodes(variables?: FetchNodesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchNodesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchNodesQuery>({ document: FetchNodesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchNodes', 'query', variables);
    }
  };
}
