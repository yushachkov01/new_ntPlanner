...
export type CreatePlannedTaskMutationVariables = Types.Exact<{
  object: Types.Planned_Tasks_Insert_Input;
}>;


export type CreatePlannedTaskMutation = { __typename?: 'mutation_root', insert_planned_tasks_one?: { __typename?: 'planned_tasks', id: any, name: string, description?: string | null, rm_task_id?: any | null, yaml_url?: string | null, time_work_id?: any | null, author_id?: any | null } | null };


export const CreatePlannedTaskDocument = gql`
    mutation createPlannedTask($object: planned_tasks_insert_input!) {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    createPlannedTask(variables: CreatePlannedTaskMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreatePlannedTaskMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreatePlannedTaskMutation>({ document: CreatePlannedTaskDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'createPlannedTask', 'mutation', variables);
    }
  };
}
