...
export type FetchRolesQuery = { __typename?: 'query_root', roles: Array<{ __typename?: 'roles', id: any, role: string }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchRoles(variables?: FetchRolesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchRolesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchRolesQuery>({ document: FetchRolesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchRoles', 'query', variables);
    }
  };
}
