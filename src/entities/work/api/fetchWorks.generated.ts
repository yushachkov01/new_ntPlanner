...
export type FetchWorksQuery = { __typename?: 'query_root', works: Array<{ __typename?: 'works', date: any, project: string, site: string, description?: string | null, time_range?: string | null, status: string, ppr_hours?: number | null, work_hours?: number | null, overtime_hours?: number | null, idInt: number }> };
