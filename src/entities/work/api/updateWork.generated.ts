...
export type UpdateWorkMutationVariables = Types.Exact<{
  ...
  set: Types.Works_Set_Input;
}>;


export type UpdateWorkMutation = { __typename?: 'mutation_root', update_works_by_pk?: { __typename?: 'works', id: number, date: any, project: string, site: string, description?: string | null, time_range?: string | null, status: string, ppr_hours?: number | null, work_hours?: number | null, overtime_hours?: number | null } | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    UpdateWork(variables: UpdateWorkMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateWorkMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateWorkMutation>({ document: UpdateWorkDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateWork', 'mutation', variables);
    }
  };
}
