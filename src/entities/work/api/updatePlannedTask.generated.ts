...
export type UpdatePlannedTaskMutationVariables = Types.Exact<{
  pk_columns: Types.Planned_Tasks_Pk_Columns_Input;
  _set: Types.Planned_Tasks_Set_Input;
}>;


export type UpdatePlannedTaskMutation = { __typename?: 'mutation_root', update_planned_tasks_by_pk?: { __typename?: 'planned_tasks', id: any, name: string, description?: string | null, rm_task_id?: any | null, yaml_url?: string | null, time_work_id?: any | null, author_id?: any | null, project_id?: any | null, status?: string | null } | null };


export const UpdatePlannedTaskDocument = gql`
    mutation UpdatePlannedTask($pk_columns: planned_tasks_pk_columns_input!, $_set: planned_tasks_set_input!) {
  update_planned_tasks_by_pk(pk_columns: $pk_columns, _set: $_set) {
    id
    name
    description
    rm_task_id
