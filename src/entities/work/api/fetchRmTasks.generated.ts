...
export type FetchRmTasksQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type FetchRmTasksQuery = { __typename?: 'query_root', rm_tasks: Array<{ __typename?: 'rm_tasks', id: any, ext_id?: number | null, name: string, status?: string | null, project_id?: any | null }> };


export const FetchRmTasksDocument = gql`
    query fetchRmTasks {
  rm_tasks {
    id
    ext_id
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchRmTasks(variables?: FetchRmTasksQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchRmTasksQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchRmTasksQuery>({ document: FetchRmTasksDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchRmTasks', 'query', variables);
    }
  };
}
