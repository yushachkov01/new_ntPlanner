...
export type FetchTimeWorksQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type FetchTimeWorksQuery = { __typename?: 'query_root', time_works: Array<{ __typename?: 'time_works', id: any, start_at?: any | null, end_at?: any | null }> };


export const FetchTimeWorksDocument = gql`
    query fetchTimeWorks {
  time_works {
    id
    start_at
    end_at
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchTimeWorks(variables?: FetchTimeWorksQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchTimeWorksQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchTimeWorksQuery>({ document: FetchTimeWorksDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchTimeWorks', 'query', variables);
    }
  };
}
