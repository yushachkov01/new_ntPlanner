...
export type FetchDevicesQuery = { __typename?: 'query_root', devices: Array<{ __typename?: 'devices', id: any, hostname: string, node_id: any, role_id: any, model_id: any }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchDevices(variables?: FetchDevicesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchDevicesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchDevicesQuery>({ document: FetchDevicesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchDevices', 'query', variables);
    }
  };
}
