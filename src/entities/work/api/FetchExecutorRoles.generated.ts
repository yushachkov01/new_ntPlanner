...
export type FetchExecutorRolesQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type FetchExecutorRolesQuery = { __typename?: 'query_root', user: Array<{ __typename?: 'user', role: string }> };


export const FetchExecutorRolesDocument = gql`
    query FetchExecutorRoles {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    FetchExecutorRoles(variables?: FetchExecutorRolesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchExecutorRolesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchExecutorRolesQuery>({ document: FetchExecutorRolesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'FetchExecutorRoles', 'query', variables);
    }
  };
}
