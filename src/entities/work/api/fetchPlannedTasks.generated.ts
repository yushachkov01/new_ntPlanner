...
export type FetchPlannedTasksQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type FetchPlannedTasksQuery = { __typename?: 'query_root', planned_tasks: Array<{ __typename?: 'planned_tasks', id: any, name: string, description?: string | null, rm_task_id?: any | null, yaml_url?: string | null, time_work_id?: any | null, author_id?: any | null }> };


export const FetchPlannedTasksDocument = gql`
    query fetchPlannedTasks {
  planned_tasks {
    id
    name
    description
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchPlannedTasks(variables?: FetchPlannedTasksQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchPlannedTasksQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchPlannedTasksQuery>({ document: FetchPlannedTasksDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchPlannedTasks', 'query', variables);
    }
  };
}
