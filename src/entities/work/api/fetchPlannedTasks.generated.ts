...
export type FetchPlannedTasksQuery = {
  __typename?: 'query_root';
  public7_planned_tasks: Array<{
    __typename?: 'public7_planned_tasks';
    id: any;
    name: string;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchPlannedTasks(
      variables?: FetchPlannedTasksQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit['signal'],
    ): Promise<FetchPlannedTasksQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<FetchPlannedTasksQuery>({
            document: FetchPlannedTasksDocument,
            variables,
