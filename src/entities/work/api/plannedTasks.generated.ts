...
export type PlannedTaskByPkQuery = { __typename?: 'query_root', planned_tasks_by_pk?: { __typename?: 'planned_tasks', id: any, name: string, description?: string | null, rm_task_id?: any | null, yaml_url?: string | null, time_work_id?: any | null, author_id?: any | null, status?: string | null } | null };
...
export type NamesLikeQuery = { __typename?: 'query_root', planned_tasks: Array<{ __typename?: 'planned_tasks', name: string }> };

export type UpdatePlannedTaskMutationVariables = Types.Exact<{
  id: Types.Scalars['uuid']['input'];
  _set: Types.Planned_Tasks_Set_Input;
}>;


export type UpdatePlannedTaskMutation = { __typename?: 'mutation_root', update_planned_tasks?: { __typename?: 'planned_tasks_mutation_response', affected_rows: number } | null };

export type InsertPlannedTaskOneMutationVariables = Types.Exact<{
  object: Types.Planned_Tasks_Insert_Input;
}>;


export type InsertPlannedTaskOneMutation = { __typename?: 'mutation_root', insert_planned_tasks_one?: { __typename?: 'planned_tasks', id: any, name: string, description?: string | null, rm_task_id?: any | null, yaml_url?: string | null, time_work_id?: any | null, author_id?: any | null, status?: string | null } | null };


export const PlannedTaskByPkDocument = gql`
    query plannedTaskByPk($id: uuid!) {
  planned_tasks_by_pk(id: $id) {
    id
    name
    description
    rm_task_id
...
export const NamesLikeDocument = gql`
  ...
  planned_tasks(where: {name: {_ilike: $pattern}}) {
    name
  }
}
    `;
export const UpdatePlannedTaskDocument = gql`
    mutation updatePlannedTask($id: uuid!, $_set: planned_tasks_set_input!) {
  update_planned_tasks(where: {id: {_eq: $id}}, _set: $_set) {
    affected_rows
  }
}
    `;
export const InsertPlannedTaskOneDocument = gql`
    mutation insertPlannedTaskOne($object: planned_tasks_insert_input!) {
  insert_planned_tasks_one(object: $object) {
    id
    name
    description
    rm_task_id
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    plannedTaskByPk(variables: PlannedTaskByPkQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<PlannedTaskByPkQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<PlannedTaskByPkQuery>({ document: PlannedTaskByPkDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'plannedTaskByPk', 'query', variables);
    },
    namesLike(variables: NamesLikeQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<NamesLikeQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<NamesLikeQuery>({ document: NamesLikeDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'namesLike', 'query', variables);
    },
    updatePlannedTask(variables: UpdatePlannedTaskMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdatePlannedTaskMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdatePlannedTaskMutation>({ document: UpdatePlannedTaskDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'updatePlannedTask', 'mutation', variables);
    },
    insertPlannedTaskOne(variables: InsertPlannedTaskOneMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<InsertPlannedTaskOneMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<InsertPlannedTaskOneMutation>({ document: InsertPlannedTaskOneDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'insertPlannedTaskOne', 'mutation', variables);
    }
  };
}
