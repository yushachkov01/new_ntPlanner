...
export type FetchProvidersQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type FetchProvidersQuery = { __typename?: 'query_root', providers: Array<{ __typename?: 'providers', id: any, name: string }> };


export const FetchProvidersDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    FetchProviders(variables?: FetchProvidersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchProvidersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchProvidersQuery>({ document: FetchProvidersDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'FetchProviders', 'query', variables);
    }
  };
}
