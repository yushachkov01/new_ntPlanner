...
export type FetchExecutorsByRoleQuery = { __typename?: 'query_root', user: Array<{ __typename?: 'user', id: number, author: string, role: string }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    FetchExecutorsByRole(variables: FetchExecutorsByRoleQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchExecutorsByRoleQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchExecutorsByRoleQuery>({ document: FetchExecutorsByRoleDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'FetchExecutorsByRole', 'query', variables);
    }
  };
}
