...
export type InsertWorkMutation = {
  __typename?: 'mutation_root';
  insert_works_one?: { __typename?: 'works'; idInt?: string | null } | null;
};
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    InsertWork(
      variables: InsertWorkMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit['signal'],
    ): Promise<InsertWorkMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<InsertWorkMutation>({
            document: InsertWorkDocument,
            variables,
