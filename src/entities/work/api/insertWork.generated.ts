...
export type InsertWorkMutationVariables = Types.Exact<{
  object: Types.Works_Insert_Input;
}>;


export type InsertWorkMutation = { __typename?: 'mutation_root', insert_works_one?: { __typename?: 'works', idInt?: string | null } | null };


export const InsertWorkDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    InsertWork(variables: InsertWorkMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<InsertWorkMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<InsertWorkMutation>({ document: InsertWorkDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'InsertWork', 'mutation', variables);
    }
  };
}
