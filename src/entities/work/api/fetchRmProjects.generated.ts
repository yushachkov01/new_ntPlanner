...
export type FetchRmProjectsQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type FetchRmProjectsQuery = { __typename?: 'query_root', rm_projects: Array<{ __typename?: 'rm_projects', id: any, ext_id?: number | null, name: string }> };


export const FetchRmProjectsDocument = gql`
    query fetchRmProjects {
  rm_projects {
    id
    ext_id
    name
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchRmProjects(variables?: FetchRmProjectsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchRmProjectsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchRmProjectsQuery>({ document: FetchRmProjectsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchRmProjects', 'query', variables);
    }
  };
}
