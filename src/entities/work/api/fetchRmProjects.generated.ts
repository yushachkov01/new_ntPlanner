...
export type FetchRmProjectsQuery = {
  __typename?: 'query_root';
  public7_rm_projects: Array<{
    __typename?: 'public7_rm_projects';
    id: any;
    ext_id: number;
    name: string;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchRmProjects(
      variables?: FetchRmProjectsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit['signal'],
    ): Promise<FetchRmProjectsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<FetchRmProjectsQuery>({
            document: FetchRmProjectsDocument,
            variables,
