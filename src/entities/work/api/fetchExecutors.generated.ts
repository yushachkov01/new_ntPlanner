...
export type FetchExecutorsQuery = { __typename?: 'query_root', users: Array<{ __typename?: 'users', id: any, email?: string | null, name?: string | null, first_name?: string | null, middle_name?: string | null, last_name?: string | null, time_zone?: string | null, is_active?: boolean | null, role_id?: any | null, group_id?: any | null }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchExecutors(variables?: FetchExecutorsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchExecutorsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchExecutorsQuery>({ document: FetchExecutorsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchExecutors', 'query', variables);
    }
  };
}
