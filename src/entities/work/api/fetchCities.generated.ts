...
export type FetchCitiesQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type FetchCitiesQuery = { __typename?: 'query_root', cities: Array<{ __typename?: 'cities', id: any, name: string, time_zone: string, branch_id: any }> };


export const FetchCitiesDocument = gql`
    query fetchCities {
  cities {
    id
    name
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchCities(variables?: FetchCitiesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchCitiesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchCitiesQuery>({ document: FetchCitiesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchCities', 'query', variables);
    }
  };
}
