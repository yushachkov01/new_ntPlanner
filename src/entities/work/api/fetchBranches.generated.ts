...
export type FetchBranchesQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type FetchBranchesQuery = { __typename?: 'query_root', branches: Array<{ __typename?: 'branches', id: any, name: string, provider_id: any }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    fetchBranches(variables?: FetchBranchesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<FetchBranchesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<FetchBranchesQuery>({ document: FetchBranchesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'fetchBranches', 'query', variables);
    }
  };
}
